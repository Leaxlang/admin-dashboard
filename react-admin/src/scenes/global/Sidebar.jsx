...
import ContactsOutlined from "@mui/icons-material/ContacsOutlined";
import ReceiptOutlined from "@mui/icons-material/ReceiptsOutlined";
...
const Sidebar = () => {
    ...
    return (
        <Box 
            sx = {{
                "& .pro-sidebar-inner": {
                    background: '${colors.primary[400]} !important',//will overwrite background
                },
                "& .pro-icon-warpper": {
